...
import { Task, TaskStatus, DailyAnchor, ExecutionLog } from '@/lib/types';
    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (dateRange === 'today' || dateRange === 'yesterday') {
           const logTasks = (t as Task[]).filter(task => !!task.id);
           const taskIds = logTasks.map(task => task.id as number);
